...
namespace ControleFinanceiro.BLL
{
    public class Fornecedor
    {
        ...
        public List<DTO.Fornecedor> Select()
        {
            return new DAL.Fornecedor().Select();
        }
        ...
        public DTO.Fornecedor SelectPelaPK(int Id)
        {
            return new DAL.Fornecedor().SelectPelaPK(Id);
        }
        ...
        public void Remover(DTO.Fornecedor Entidade)
        {
            new DAL.Fornecedor().Remover(Entidade);
        }
        ...
        public void Cadastro(DTO.Fornecedor Entidade)
        {
            new DAL.Fornecedor().Cadastro(Entidade);
        }
    }
}
