...
namespace ControleFinanceiro.BLL
{
    public class Perfil
    {
        ...
        public List<DTO.Perfil> Select()
        {
            return new DAL.Perfil().Select();
        }
        ...
        public DTO.Perfil SelectPelaPK(int Id)
        {
            return new DAL.Perfil().SelectPelaPK(Id);
        }
        ...
        public void Remover(DTO.Perfil Entidade)
        {
            new DAL.Perfil().Remover(Entidade);
        }
        ...
        public void Cadastro(DTO.Perfil Entidade)
        {
            new DAL.Perfil().Cadastro(Entidade);
        }
    }
}
