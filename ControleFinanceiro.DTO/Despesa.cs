...
namespace ControleFinanceiro.DTO
{
    public class Despesa : Base
    {
        ...
        [AtributoBind(ChavePrimaria = true
            , ProcedureAlterar = "SPUDespesas"
            , ProcedureInserir = "SPIDespesas"
            , ProcedureRemover = "SPDDespesas"
            , ProcedureListarTodos = "SPSDespesas"
            , ProcedureSelecionar = "SPSDespesasPelaPK")]
