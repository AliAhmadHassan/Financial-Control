<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DespesaRateio.aspx.cs"
    Inherits="ControleFinanceiro.UI.Presentation.Pages.Logados.Financeiro.DespesaRateio" %>
...
<body>
    ...
    <div>
        ...
        <asp:GridView ID="GdvDespesa" runat="server" AutoGenerateColumns="False" OnPageIndexChanging="GdvDespesa_PageIndexChanging"
            OnRowCommand="GdvDespesa_RowCommand" OnRowDataBound="GdvDespesa_RowDataBound"
            Font-Size="Small">
            <Columns>
                ...
                <asp:BoundField DataField="Vencimento" HeaderText="Vencimento" DataFormatString="{0:dd/MM/yyyy}"
                    NullDisplayText="" />
                <asp:BoundField DataField="DtPgto" HeaderText="Dt. Pgto" DataFormatString="{0:dd/MM/yyyy}"
                    NullDisplayText="" />
                <asp:BoundField DataField="Descricao" HeaderText="Descrição" DataFormatString="{0:dd/MM/yyyy}"
                    NullDisplayText="" />
                ...
                <asp:ButtonField ButtonType="Image" HeaderText="Boleto" ImageUrl="~/Imagens/search-icon.png"
                    CommandName="ExibirBoleto">
                    <ControlStyle Width="16px" />
                    <ItemStyle Height="16px" Width="16px" HorizontalAlign="Center" />
                </asp:ButtonField>
                <asp:ButtonField ButtonType="Image" HeaderText="Comprovante" ImageUrl="~/Imagens/search-icon.png"
                    CommandName="ExibirComprovante">
                    <ControlStyle Width="16px" />
                    <ItemStyle Height="16px" Width="16px" HorizontalAlign="Center" />
                </asp:ButtonField>
            </Columns>
        ...
        <asp:ModalPopupExtender ID="PanelTipoRateio_ModalPopupExtender" runat="server" TargetControlID="hdfAux"
            CancelControlID="btnTipoRateioCancel" BackgroundCssClass="modalBackground" Enabled="True"
            PopupControlID="Panel_TipoRateio">
        </asp:ModalPopupExtender>
        <asp:Panel ID="Panel_TipoRateio" CssClass="modalPopup" runat="server">
            <div style="overflow: auto;">
                <asp:RadioButtonList ID="RbtnTipoRateio" runat="server" Height="170px" Width="308px" >
                    <asp:ListItem Selected="True">Manual</asp:ListItem>
                    <asp:ListItem Value="Predio19">Rateio Predio 19º (Sem P.A. Fixa)</asp:ListItem>
                    <asp:ListItem Value="Predio190">Rateio Predio 190º</asp:ListItem>
                    <asp:ListItem Value="Pessoas">Rateio por Pessoas</asp:ListItem>
                    <asp:ListItem Value="Pessoas_Operacional">Rateio por Pessoas (Operacional)</asp:ListItem>
                    <asp:ListItem Value="Salario">Rateio por Salario</asp:ListItem>
                    <asp:ListItem Value="Predio19_0">Rateio Predio 19º + 0º</asp:ListItem>
                </asp:RadioButtonList>
                <br />
                <asp:Button ID="btnTipoRateioOk" Text="Ok" runat="server" 
                    onclick="btnTipoRateioOk_Click" style="height: 26px" />
                <asp:Button ID="btnTipoRateioCancel" Text="Cancelar" runat="server" 
                    onclick="btnTipoRateioCancel_Click" />
                
            </div>
        </asp:Panel>
        <asp:ModalPopupExtender ID="Panel_Carteira_ModalPopupExtender" runat="server" TargetControlID="hdfAux"
            CancelControlID="btCadastrar_Nao" BackgroundCssClass="modalBackground" Enabled="True"
            PopupControlID="Panel_Carteira">
        </asp:ModalPopupExtender>
        <asp:Panel ID="Panel_Carteira" CssClass="modalPopup" runat="server">
            <div style="overflow: auto; height: 600px; width: 620px">
                <asp:Literal ID="ltlCarteira" runat="server"></asp:Literal>
                <asp:Button ID="btnCarteiraSalvar" Width="79px" runat="server" CssClass="ButtonSalvar"
                    OnClick="btnCarteiraSalvar_Click" />
                <asp:Button ID="btnCarteiraCancelar" Width="79px" runat="server" CssClass="ButtonCancelar" />
            </div>
        </asp:Panel>
    </div>
